...
const int targetPowerOutput = 110; 
...
void Main() { 
    ...
    if(referencePanel == null) { 
        ...
        for(int i = 0; i < GridTerminalSystem.Blocks.Count; i++) { 
            if(GridTerminalSystem.Blocks[i].CustomName.Contains(referencePanelName)) { 
                referencePanel = GridTerminalSystem.Blocks[i] as IMySolarPanel; 
                if(referencePanel != null) 
                    break; 
            } 
        } 
    ...
    if(timer == null) { 
        ...
        for(int i = 0; i < GridTerminalSystem.Blocks.Count; i++) { 
            if(GridTerminalSystem.Blocks[i].CustomName.Contains(timerName)) { 
                timer = GridTerminalSystem.Blocks[i] as IMyTimerBlock; 
                if(timer != null) 
                    break; 
            } 
        } 
